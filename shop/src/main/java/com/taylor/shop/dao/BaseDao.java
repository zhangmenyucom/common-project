...
public interface BaseDao<T> {
	...
	/**
	 * 方法描述:根据传入的SQL，返回查询的对象（只返回一行记录）
	 * <调用commonMapper中的NewSelectBySql实现>
	 *
	...
	/**
	 * 方法描述:根据传入的sql，返回查询结果的Map结构列表
	 * <调用commonMapper中的NewMapSelectBySql实现>
	 *
	 * @param sql				查询SQL
	...
	/**
	 * 方法描述:根据传入的sql，返回一条查询结果记录的Map结构列表
	 * <调用commonMapper中的NewMapSelectBySql实现>
	 *
	 * @param sql				查询SQL
	...
	/**
	 * 方法描述:带事务的，根据sql添加数据
	 * <调用commonMapper中的NewInsertBySql实现>
	 *
	 * @param sql
	...
	/**
	 * 方法描述:带事务处理的通用update方法，根据传入的Sql更新
	 * <调用commonMapper中的NewUpdateBySql实现>
	 *
	 * @param sql
	...
	/**
	 * 方法描述:带事务处理的通用update方法，返回更新成功记录数，根据传入的Sql更新
	 * <调用commonMapper中的NewUpdateBySql实现>
	 * 
	 * @param sql				更新数据的sql
     ...
     * This method corresponds to the database table ielts_admin_user
     *
